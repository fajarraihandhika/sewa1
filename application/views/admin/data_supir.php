        ...
        <div class="section-body">
            <div class="trx-card">
                <div class="trx-card-head">
                    <div class="trx-card-title">Daftar Supir Rental</div>
                    <a href="<?php echo base_url('admin/data_supir/tambah_supir') ?>" class="btn btn-primary btn-sm" style="border-radius: 8px; font-weight: 600;">
                        ...
                        <table class="trx-tbl">
                            <thead>
                                <tr>
                                    ...
                                    <th>Supir</th> <th>Nomor Telepon</th>
                                    <th>Alamat</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex; align-items: center; gap: 12px;">
                                                <div style="width: 55px; height: 45px; background: #fff; border: 1px solid #e2e8f0; border-radius: 6px; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0;">
                                                    <?php if(!empty($s->foto) && file_exists('assets/upload/'.$s->foto)): ?>
                                                        <img src="<?php echo base_url().'assets/upload/'.$s->foto ?>" alt="Foto" style="max-width: 100%; max-height: 100%; object-fit: cover;">
                                                    <?php else: ?>
                                                ...
                                                <div>
                                                    <div class="trx-name"><?php echo $s->nama ?></div>
                                                    <div class="trx-sub">ID Supir: #<?php echo $s->id_supir ?></div>
                                                </div>
                                            </div>
                                        </td>

                                        <td>
                                            <div class="trx-num"><?php echo $s->no_telepon ?></div>
                                        </td>
                                        <td>
                                            <div class="trx-date" style="white-space: normal; max-width: 250px;"><?php echo $s->alamat ?></div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div style="display: flex; gap: 4px; justify-content: center;">
                                                <a href="<?php echo base_url('admin/data_supir/detail_supir/').$s->id_supir ?>" class="trx-btn-icon trx-btn-info" title="Detail">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                
                                                <a href="<?php echo base_url('admin/data_supir/update_supir/').$s->id_supir ?>" class="trx-btn-icon trx-btn-info" style="background: #FEF3C7; color: #92400E;" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>

                                                <a href="<?php echo base_url('admin/data_supir/delete_supir/').$s->id_supir ?>" class="trx-btn-icon trx-btn-danger" onclick="return confirm('Yakin hapus data supir ini?')" title="Hapus">
